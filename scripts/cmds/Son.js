...
module.exports.onStart = async function({ api, event }) {
    const botAdmins = ['61572403596870']; // tor uid aiikhane dee
    ...
    api.getUserInfo(mention, async (err, userInfo) => {
        ...
        const msg = [
            ...
            `কিরে বান্দির &{genderText} হেডা মাগির পুত!`,
            `তোর মারে ১কেজি গুয়া মারমু 😻`,
            `তোর মারে doggy style চুদবো 😍`,
            `তোর মায়ের ভোদার ভিতরে landmines সেট করে ফাটাই দিবো 🤡`,
            `তুই তো তোর বাপের হোগা দিয়া বের হইসচ🥰`,
